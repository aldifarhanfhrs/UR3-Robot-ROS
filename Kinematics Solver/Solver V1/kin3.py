...
if __name__ == '__main__':
    ed = np.matrix([[0.08726646], [-0.99483768], [0.78539817], [0.26179938],
                    [0.08726646], [0.08726646]])
    print("Current angles (radian):")
    print(ed)

    transform = forward_kinematic_solution(DH_matrix_UR3, ed)
    print()
    print("Forward Kinematics Result:")
    print(transform)
    print()

    print("Inverse Kinematics Result (all solutions):")
    IKS = inverse_kinematic_solution(DH_matrix_UR3, transform)
    print(IKS)
    print()
    ...
    result_degrees = np.degrees(IKS)
    print()
    print("Inverse Kinematics Solution (in degrees):")
